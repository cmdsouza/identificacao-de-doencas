...
class compareImages
{
	...
	{
		/*Seleciona as caracteristicas da imagem que foi selecionada*/
	...
	{
		/* Transforma a imagem em um quadrado de 8x8 e retorna suas caracteristicas*/
	...
	{
		/*Retorna o valor medio das cores e uma lista de todas as cores, pixel a pixel*/
		$colorList = array();
		$colorSum = 0;
		for($a = 0;$a<8;$a++)
		{
	...
	{
		/*Cria um array de 0 ou 1; 0 = cor do pixel menor que o valor medio da imagem, 1 = maior que o valor médio*/
		$bits = array();
	...
	{
		/*Função principal: mostra a distância do entre os bits das duas imagens*/
