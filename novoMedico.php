               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                      <ul class="nav navbar-nav">
                        ...
                        <li><a class="active" href="novoMedico.php">Novo Dentista</a></li> 
		...
		<div class="container">
		  ...
		  <div class="tab-content">
			<div id="home" class="tab-pane fade in active">
				...
				<form method='POST' action='cadastrarMedico.php'>
				   ...
				   <div class="col-md-3 col-sm-6 col-xs-12">
					  <div class="service-widget">
						<div class="input-group-prepend">
							...
							<input type='password' name='senha' placeholder='Com pontuação' class="form-control">
					  </div>
					  <!-- end service -->
				   </div>
				   <div class="col-md-3 col-sm-6 col-xs-12">
					  <div class="service-widget">
						<div class="input-group-prepend">
							<span class="input-group-text" id="basic-addon3">CRO</span>
							</div>
							<input type='text' name='cro' placeholder='Com pontuação e Estado' class="form-control">
					  </div>
					  <!-- end service -->
				   </div>
				</div> 
