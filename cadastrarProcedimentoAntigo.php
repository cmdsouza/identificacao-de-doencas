...
$sql3 = "INSERT INTO tb_procedimento(nr_idProcedimento, nm_nomeProcedimento, nm_observacoes, dt_solicitacao, nr_cpfMedico, nr_cpfPaciente) VALUES (NULL, '".$procedimento."', '".$observacoes."', '".$dataSolicitacao."', '".$medico."', '".$cpf."')";
